    ...
    <div className='w-full min-h-screen'>
      ...
      <div className='flex md:grid md:grid-cols-[auto_1fr] w-full min-h-screen md:min-h-auto'>
        ...
        <div className='relative min-w-0 flex-1 transition-all duration-300'>
          ...
          {/* 桌面端顶部按钮 */}
          <LiquidGlassContainer className='absolute top-2 right-4 z-20 hidden md:flex items-center gap-2 px-2 py-1' roundedClass='rounded-full' intensity='medium' shadow='lg' border='subtle'>
            <ThemeToggle />
            <UserMenu />
